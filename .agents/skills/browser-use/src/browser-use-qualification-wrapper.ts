...
const RUNTIME_ENTRY = ".agents/skills/browser-use/src/browser-use-qualification-runtime.ts";
...
export async function prepareSealedQualificationBundle(input: {
	...
	const body: Record<string, unknown> = {
		...
		packages: {
			browser_use: await packageIdentity(".agents/skills/browser-use/package.json"),
