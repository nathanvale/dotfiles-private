...
Instead of reading 20K-50K tokens of code to understand structure, query this skill and get 200-500 token JSON responses with exact file:line references.
...
**Why scripts only?**
Scripts read only needed sections of PROJECT_INDEX.json (200-500 tokens) instead of loading the entire file (26,000+ tokens) = **98% token reduction**
