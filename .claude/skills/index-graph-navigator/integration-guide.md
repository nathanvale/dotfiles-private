...
Instead of reading 20K-50K tokens of code to understand structure, other skills query index-graph-navigator and get 200-500 token JSON responses with exact file:line references.
...
3. Analyze call patterns (3000 tokens)
Total: 10,000+ tokens to find what calls parseDate()
```
...
3. Read ONLY those specific locations (1000 tokens)
Total: 1,200 tokens (88% reduction!)
```
...
- **@integration-examples.md** - 5 skill integration examples (domain-analyzer, debug-assistant, refactor-planner, test-coverage-analyzer, dependency-auditor)
