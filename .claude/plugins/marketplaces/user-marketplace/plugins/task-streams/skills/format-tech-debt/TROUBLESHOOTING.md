...
Common issues when enriching tech debts and their solutions.

---

## Issue 1: Cannot Determine File Location

**Symptom**: Tech Debt description mentions issue but doesn't specify file/line numbers
...
**Symptom**: Can't determine realistic hours for complex/vague tech debt items
...
**Symptom**: No code context provided in tech debt item, can't show current/proposed
...
**Symptom**: Tech Debt could be P0 or P1, P1 or P2, etc.
...
1. **Invoke component-manager skill**:
   ...
   - Use in tech debt item: **Component:** C03: Migration & Batch Processing
...
## Issue 10: Tech Debt Too Complex to Enrich in One Pass

**Symptom**: Tech Debt involves multiple unrelated issues or massive refactoring

**Solutions**:

1. **Split into multiple tech debt items**:
...
3. **Mark as epic requiring decomposition**:
   ```markdown
   **Note:** This tech debt item represents an epic-level change. Recommend decomposing into 3-5 sub-tasks before implementation.
   ```
...
1. **Review @EXAMPLES.md** for similar tech debt item patterns
