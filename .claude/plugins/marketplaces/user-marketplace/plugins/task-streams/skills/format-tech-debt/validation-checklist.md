...
Complete quality checklist to verify enriched tech debt items before finalizing. Every item must pass before outputting tasks.

---

## Pre-Output Checklist

Before finalizing any enriched tech debt item, verify ALL items below:
...
- [ ] **Minimum 3 criteria** present (5 for complex tech debt items)
...
- [ ] **Minimum 3 steps** present (5+ for complex tech debt items)
...
### For P2/P3 (Medium/Low) Tech Debts
...
1. **Read through entire tech debt item** as if you're the implementer
