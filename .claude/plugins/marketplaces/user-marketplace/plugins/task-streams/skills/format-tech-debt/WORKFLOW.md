...
### Step 1: Extract Tech Debt Metadata

**Input:** Raw code review tech debt item (title, description, location hint)

**Actions:**

- Parse tech debt item priority/severity keywords
- Extract approximate file location
- Identify complexity indicators

**Output:** Basic tech debt item structure with initial metadata
...
**Input:** Tech Debt complexity and scope
...
**Input:** Tech Debt description and requirements
...
**Input:** Tech Debt scope and dependencies
...
**Input:** Tech Debt description and technical approach
...
**Input:** Tech Debt context and related work
...
**Input:** Tech Debt subject matter and codebase area

**Actions:**

- Invoke **component-manager skill** to classify tech debt item
- Component-manager searches existing components for match
- Creates new component if no match found
- Returns component code (C##) for use in tech debt item

**Component-Manager Workflow:**

1. Search: "Batch processing migration" → Finds C03
2. Return: C03: Migration & Batch Processing
3. Use in tech debt item: **Component:** C03: Migration & Batch Processing
...
### Step 12: Output Enriched Tech Debt

**Input:** All enrichments from Steps 1-11

**Actions:**

- Combine all enrichments into complete tech debt item format
...
**Output:** Complete enriched tech debt item ready for task decomposition

**Example:** See @EXAMPLES.md for complete enriched tech debt items

---

## Workflow Shortcuts

### For Simple Tech Debts (P2/P3)

Some steps can be simplified for low-priority tech debt items:
...
### For Complex Tech Debts (P0/P1)

Expand certain steps for critical tech debt items:
