# Finding Enrichment Workflow

Detailed 12-step process for transforming raw code review findings into fully enriched task-decomposable output.
...
**Input:** Raw code review finding (title, description, location hint)

**Actions:**

- Parse finding priority/severity keywords
- Extract approximate file location
- Identify complexity indicators

**Output:** Basic finding structure with initial metadata
...
**Input:** Finding complexity and scope
...
**Input:** Finding description and requirements
...
**Input:** Finding scope and dependencies
...
**Input:** Finding description and technical approach
...
**Input:** Finding context and related work
...
### Step 12: Output Enriched Finding

**Input:** All enrichments from Steps 1-11

**Actions:**

- Combine all enrichments into complete finding format
...
**Output:** Complete enriched finding ready for task decomposition

**Example:** See @EXAMPLES.md for complete enriched findings

---

## Workflow Shortcuts

### For Simple Findings (P2/P3)

Some steps can be simplified for low-priority findings:
...
### For Complex Findings (P0/P1)

Expand certain steps for critical findings:
