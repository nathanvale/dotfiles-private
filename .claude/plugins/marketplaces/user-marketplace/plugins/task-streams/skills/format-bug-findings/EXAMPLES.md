# Enriched Finding Examples

Complete examples of properly enriched bug findings with all 10 required elements.
...
Use this template when creating new enriched findings:
