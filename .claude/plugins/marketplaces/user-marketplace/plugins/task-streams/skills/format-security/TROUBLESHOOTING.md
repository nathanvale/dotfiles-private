...
Common issues when enriching security security findings and their solutions.

---

## Issue 1: Cannot Determine File Location

**Symptom**: Security Finding description mentions issue but doesn't specify file/line numbers
...
**Symptom**: Can't determine realistic hours for complex/vague security findings
...
**Symptom**: No code context provided in security finding, can't show current/proposed
...
**Symptom**: Security Finding could be P0 or P1, P1 or P2, etc.
...
1. **Invoke component-manager skill**:
   ...
   - Use in security finding: **Component:** C03: Migration & Batch Processing
...
## Issue 10: Security Finding Too Complex to Enrich in One Pass

**Symptom**: Security Finding involves multiple unrelated issues or massive refactoring

**Solutions**:

1. **Split into multiple security findings**:
...
3. **Mark as epic requiring decomposition**:
   ```markdown
   **Note:** This security finding represents an epic-level change. Recommend decomposing into 3-5 sub-tasks before implementation.
   ```
...
1. **Review @EXAMPLES.md** for similar security finding patterns
