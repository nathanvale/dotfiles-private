...
Complete quality checklist to verify enriched security findings before finalizing. Every item must pass before outputting tasks.

---

## Pre-Output Checklist

Before finalizing any enriched security finding, verify ALL items below:
...
- [ ] **Minimum 3 criteria** present (5 for complex security findings)
...
- [ ] **Minimum 3 steps** present (5+ for complex security findings)
...
### For P0 (Critical) Security Findings
...
### For P2/P3 (Medium/Low) Security Findings
...
1. **Read through entire security finding** as if you're the implementer
