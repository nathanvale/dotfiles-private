# Security Finding Enrichment Workflow

Detailed 12-step process for transforming raw code review security findings into fully enriched task-decomposable output.

---

## Complete Workflow

### Step 1: Extract Security Finding Metadata

**Input:** Raw code review security finding (title, description, location hint)

**Actions:**

- Parse security finding priority/severity keywords
- Extract approximate file location
- Identify complexity indicators

**Output:** Basic security finding structure with initial metadata
...
**Input:** Security Finding complexity and scope
...
**Input:** Security Finding description and requirements
...
**Input:** Security Finding scope and dependencies
...
**Input:** Security Finding description and technical approach
...
**Input:** Security Finding context and related work
...
**Input:** Security Finding subject matter and codebase area

**Actions:**

- Invoke **component-manager skill** to classify security finding
- Component-manager searches existing components for match
- Creates new component if no match found
- Returns component code (C##) for use in security finding

**Component-Manager Workflow:**

1. Search: "Batch processing migration" → Finds C03
2. Return: C03: Migration & Batch Processing
3. Use in security finding: **Component:** C03: Migration & Batch Processing
...
### Step 12: Output Enriched Security Finding

**Input:** All enrichments from Steps 1-11

**Actions:**

- Combine all enrichments into complete security finding format
...
**Output:** Complete enriched security finding ready for task decomposition

**Example:** See @EXAMPLES.md for complete enriched security findings

---

## Workflow Shortcuts

### For Simple Security Findings (P2/P3)

Some steps can be simplified for low-priority security findings:
...
### For Complex Security Findings (P0/P1)

Expand certain steps for critical security findings:
