# Enriched Security Finding Examples

Complete examples of properly enriched security security findings with all 10 required elements.
...
## Template for New Security Findings

Use this template when creating new enriched security findings:
