...
Detailed 12-step process for transforming raw code review tasks into fully enriched task-decomposable output.
...
**Input:** Raw code review task (title, description, location hint)

**Actions:**

- Parse task priority/severity keywords
- Extract approximate file location
- Identify complexity indicators

**Output:** Basic task structure with initial metadata
...
**Input:** Task complexity and scope
...
**Input:** Task scope and dependencies
...
**Input:** Task description and technical approach
...
**Input:** Task context and related work
...
### Step 12: Output Enriched Task

**Input:** All enrichments from Steps 1-11

**Actions:**

- Combine all enrichments into complete task format
...
**Output:** Complete enriched task ready for task decomposition

**Example:** See @EXAMPLES.md for complete enriched tasks

---

## Workflow Shortcuts

### For Simple Tasks (P2/P3)

Some steps can be simplified for low-priority tasks:
...
### For Complex Tasks (P0/P1)

Expand certain steps for critical tasks:
