...
Common issues when enriching generic tasks and their solutions.

---

## Issue 1: Cannot Determine File Location

**Symptom**: Task description mentions issue but doesn't specify file/line numbers
...
**Symptom**: Can't determine realistic hours for complex/vague tasks
...
**Symptom**: No code context provided in task, can't show current/proposed
...
**Symptom**: Task could be P0 or P1, P1 or P2, etc.
...
1. **Invoke component-manager skill**:
   ...
   - Use in task: **Component:** C03: Migration & Batch Processing
...
## Issue 10: Task Too Complex to Enrich in One Pass

**Symptom**: Task involves multiple unrelated issues or massive refactoring
...
3. **Mark as epic requiring decomposition**:
   ```markdown
   **Note:** This task represents an epic-level change. Recommend decomposing into 3-5 sub-tasks before implementation.
   ```
...
1. **Review @EXAMPLES.md** for similar task patterns
