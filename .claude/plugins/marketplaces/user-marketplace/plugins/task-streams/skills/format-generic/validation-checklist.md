...
Complete quality checklist to verify enriched tasks before finalizing. Every item must pass before outputting tasks.

---

## Pre-Output Checklist

Before finalizing any enriched task, verify ALL items below:
...
- [ ] **Minimum 3 criteria** present (5 for complex tasks)
...
- [ ] **Minimum 3 steps** present (5+ for complex tasks)
...
1. **Read through entire task** as if you're the implementer
