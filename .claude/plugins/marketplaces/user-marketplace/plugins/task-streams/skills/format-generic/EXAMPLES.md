# Enriched Task Examples

Complete examples of properly enriched generic tasks with all 10 required elements.
...
Use this template when creating new enriched tasks:
