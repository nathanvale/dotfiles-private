...
Common issues when enriching specs and their solutions.

---

## Issue 1: Cannot Determine File Location

**Symptom**: Spec description mentions issue but doesn't specify file/line numbers
...
**Symptom**: Can't determine realistic hours for complex/vague specs
...
**Symptom**: No code context provided in spec, can't show current/proposed
...
**Symptom**: Spec could be P0 or P1, P1 or P2, etc.
...
1. **Invoke component-manager skill**:
   ...
   - Use in spec: **Component:** C03: Migration & Batch Processing
...
## Issue 10: Spec Too Complex to Enrich in One Pass

**Symptom**: Spec involves multiple unrelated issues or massive refactoring
...
3. **Mark as epic requiring decomposition**:
   ```markdown
   **Note:** This spec represents an epic-level change. Recommend decomposing into 3-5 sub-tasks before implementation.
   ```
...
1. **Review @EXAMPLES.md** for similar spec patterns
