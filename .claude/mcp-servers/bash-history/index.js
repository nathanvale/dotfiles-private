...
tool('search_history', {
  description: 'Search command history using atuin. Returns matching commands with timestamps, exit codes, and full command text.',
  inputSchema: {
    ...
    include_failed: z.boolean().default(false).describe('Include commands that failed (non-zero exit code). Default: false'),
  },
