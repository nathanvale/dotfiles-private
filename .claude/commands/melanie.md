...
1. **Load the communication style guide** from `.claude/rules/melanie/nathan-melanie-communication-style.md`
...
- **What do you want to express?** (check-in, making plans, processing feelings, romantic moment, etc.)
...
**Opens:** "Hey Bestie," "Morning gorgeous," "Hi my love"
**Closes:** "xx" or "xxx" (NEVER "xo")
**Emojis:** 1-3 max, purposeful placement
**NO:** Bold, italics, generic compliments, "babe/honey," excessive punctuation
...
❌ "Hey babe" (use "Bestie" or "gorgeous")
❌ "xoxo" (use "xx" or "xxx")
❌ 5+ emojis (max 1-3)
❌ Generic romance ("you complete me")
❌ Toxic positivity (acknowledge complexity)
❌ All lowercase (Nathan uses proper grammar)

## Your Goal

Help Nathan express what's genuinely in his heart using his authentic voice. Not writing for him, but helping him find the words that feel true.
