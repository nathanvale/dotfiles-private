...
- Accepted repo decisions are terminal; route to the repository's declared
  decision document or ADR index.
...
- If the storage choice is unresolved and affects ownership, privacy, durability, or side effects, use `grill-with-docs`.
