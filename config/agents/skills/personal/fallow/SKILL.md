...
- Repo-local front door: `config/agents/skills/personal/fallow/package.json#scripts` (`fallow-runner`).
- Runner implementation: `config/agents/skills/personal/fallow/src/fallow-runner.ts`.
- Public command contract, result vocab, and repair action ids: `config/agents/skills/personal/fallow/src/command-contract.ts`.
- Runner tests: `config/agents/skills/personal/fallow/src/fallow-runner.test.ts`.
- Live compatibility smoke: `config/agents/skills/personal/fallow/src/fallow-runner.live.test.ts`.
- Command recipes: `config/agents/skills/personal/fallow/references/commands.md`.
- Workflow recipes: `config/agents/skills/personal/fallow/references/workflows.md`.
- Safety policy: `config/agents/skills/personal/fallow/references/safety.md`.
- CI adoption notes: `config/agents/skills/personal/fallow/references/ci.md`.
- Source lineage: `config/agents/skills/personal/fallow/PROVENANCE.md`.
