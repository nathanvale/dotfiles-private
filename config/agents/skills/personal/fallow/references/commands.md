...
- Public command surface: `config/agents/skills/personal/fallow/src/command-contract.ts`.
- Parser and execution mapping: `config/agents/skills/personal/fallow/src/fallow-runner.ts`.
- Command surface proof: `config/agents/skills/personal/fallow/src/fallow-runner.test.ts`.
- Live compatibility proof: `config/agents/skills/personal/fallow/src/fallow-runner.live.test.ts`.
- Official Fallow commands: `https://docs.fallow.tools/llms.txt`.

## Help

```bash
cd config/agents/skills/personal/fallow
