...
async function fixture() {
	...
	await mkdir(join(sourceRoot, "config/agents/skills/personal/browser-use/actions"), { recursive: true });
	await mkdir(join(sourceRoot, "config/agents/skills/personal/browser-use/runbooks"), { recursive: true });
	await writeFile(join(sourceRoot, "config/agents/skills/personal/browser-use/actions/registry.json"), '{"actions":[]}\n');
...
async function commitRunbook(
	...
	const relativePath = `config/agents/skills/personal/browser-use/runbooks/${serviceId}/${flowId}/runbook.json`;
	await mkdir(join(sourceRoot, "config/agents/skills/personal/browser-use/runbooks", serviceId, flowId), {
		recursive: true,
	});
	await writeFile(
	...
	await git(
		sourceRoot,
		"add",
		"config/agents/skills/personal/browser-use/actions/registry.json",
		relativePath,
	);
...
describe("authoring-to-active-generation composed acceptance", () => {
	...
	test("production front doors compose UniFi plus a promoted action and preserve AE4 generation semantics", async () => {
		...
		await git(sourceRoot, "add", "config/agents/skills/personal/browser-use/actions/registry.json", `config/agents/skills/personal/browser-use/actions/assets/${actionResult.digest}.js`);
		...
		await git(sourceRoot, "add", "config/agents/skills/personal/browser-use/actions/registry.json");
		...
		await git(sourceRoot, "add", "config/agents/skills/personal/browser-use/runbooks");
		...
		await git(sourceRoot, "add", "config/agents/skills/personal/browser-use/runbooks/fixture/later-read/runbook.json");
