...
- Targets and operations contracts: `config/agents/skills/personal/browser-use/src/command-contract.ts`.
...
- Historical findings and rationale live in `config/agents/skills/personal/browser-use/PROVENANCE.md`.

## Research

- Chrome for Testing capability, authentication, profile, and lifecycle
  trade-offs:
  `config/agents/skills/personal/browser-use/docs/research/2026-07-28-chrome-for-testing-browser-use-tradeoffs.md`.
