...
- Browser-use front door: `config/agents/skills/personal/browser-use/SKILL.md`.
...
- Treat `config/agents/skills/personal/browser-use/.coding-task-tracker/repo.json` as the browser-use owner identity.
- Keep `config/agents/skills/personal/browser-use/.coding-task-tracker/local.json` ignored.
