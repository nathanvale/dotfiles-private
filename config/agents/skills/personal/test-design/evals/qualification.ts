...
export const QUALIFICATION_SOURCE_PATHS = [
	...
	"config/agents/skills/personal/test-design/SKILL.md",
	"config/agents/skills/personal/test-design/evals/pairwise-scenarios.json",
	...
	"config/agents/skills/personal/test-design/references/browser-and-ui.md",
	"config/agents/skills/personal/test-design/references/influences.md",
	"config/agents/skills/personal/test-design/references/installation-host-hosted.md",
	"config/agents/skills/personal/test-design/references/pattern-library.md",
	"config/agents/skills/personal/test-design/references/process-and-cli.md",
	"config/agents/skills/personal/test-design/references/runtime-ci-platform.md",
	"config/agents/skills/personal/test-design/references/runner-execution.md",
	"config/agents/skills/personal/test-design/references/state-concurrency-recovery.md",
	"config/agents/skills/personal/test-design/tests/skill-contract.test.ts",
] as const;
...
type QualificationReceipt = {
	schema_version: 1;
	generated_by: "config/agents/skills/personal/test-design/evals/qualification.ts";
...
async function deterministic(): Promise<void> {
	const proc = Bun.spawn({
		cmd: [
			resolve(repositoryRoot, "config/agents/skills/personal/test-runner/src/test-runner.sh"),
			"run",
			"--",
			"config/agents/skills/personal/test-design/tests/skill-contract.test.ts",
			"scripts/multi-agent-smoke.test.ts",
