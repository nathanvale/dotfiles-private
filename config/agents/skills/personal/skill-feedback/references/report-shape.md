...
Source owners: `config/agents/skills/personal/skill-feedback/src/command-contract.ts`,
`config/agents/skills/personal/skill-feedback/src/runtime-contract.ts`,
`config/agents/skills/personal/skill-feedback/src/runtime-file-safety.ts`,
`config/agents/skills/personal/skill-feedback/src/raw-object.ts`,
`config/agents/skills/personal/skill-feedback/src/decision-surface.ts`,
`config/agents/skills/personal/skill-feedback/src/report-normalizer.ts`,
`config/agents/skills/personal/skill-feedback/src/inbox-read-model.ts`,
`config/agents/skills/personal/skill-feedback/src/correlation-witness-artifacts.ts`,
`config/agents/skills/personal/skill-feedback/src/correlation-witness-workflow.ts`,
`config/agents/skills/personal/skill-feedback/src/review-ledger-reducer.ts`,
`config/agents/skills/personal/skill-feedback/src/ledger-anchor-adapter.ts`,
`config/agents/skills/personal/skill-feedback/src/report-helpers.ts`, and
`config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts`.

## Source Layout

- Keep `config/agents/skills/personal/skill-feedback/src/` flat.
...
- Keep exact v2 review fields, enum values, parser rules, and result version in `config/agents/skills/personal/skill-feedback/src/command-contract.ts`.
- Keep runtime and read-target interfaces in `config/agents/skills/personal/skill-feedback/src/runtime-contract.ts`.
- Keep review and health result assembly in `config/agents/skills/personal/skill-feedback/src/decision-surface.ts`.
- Keep persisted report normalization in `config/agents/skills/personal/skill-feedback/src/report-normalizer.ts`.
- Keep safe inbox read facts in `config/agents/skills/personal/skill-feedback/src/inbox-read-model.ts`.
- Keep correlation artifact IO and diagnostic classification in `config/agents/skills/personal/skill-feedback/src/correlation-witness-artifacts.ts`.
- Keep correlation witness workflow behavior in `config/agents/skills/personal/skill-feedback/src/correlation-witness-workflow.ts`.
...
- `normalizeReport` in `config/agents/skills/personal/skill-feedback/src/report-normalizer.ts` strips raw inbox `skill_run_id_provenance` unless proof context is verified; raw JSON cannot mint `same_trusted_run`, `correlation_owned`, or `corroborated`.
- Keep exact health projection fields, enum values, reason ids, and next-action ids in `config/agents/skills/personal/skill-feedback/src/command-contract.ts`.
- Keep exact correlate result fields, reason ids, candidate classes, and action ids in `config/agents/skills/personal/skill-feedback/src/command-contract.ts`.
...
- Keep glossary terms in `config/agents/skills/personal/skill-feedback/CONTEXT.md`.
...
- Emit `inbox_status` from the enum owned by `config/agents/skills/personal/skill-feedback/src/command-contract.ts`.
...
- Summarize primary correlation using the enum owned by `config/agents/skills/personal/skill-feedback/src/command-contract.ts`.
