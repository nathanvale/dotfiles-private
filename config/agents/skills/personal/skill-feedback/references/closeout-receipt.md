...
Source owner: `config/agents/skills/personal/skill-feedback/src/command-contract.ts`.
Command owner: `config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts`.
