...
```bash
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts
```

Inspect help:

```bash
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts --help
```

Check inbox health:

```bash
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts health --plain
```

Use JSON for automation:

```bash
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts health
```
...
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts dashboard
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts --help

# Human dashboard paths
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts reports --limit 10
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts reports --lane all --json
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts report report:<id>
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts usage --limit 10
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts queue --include-weak
...
# Review
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts review
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts review --plain
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts review --repo /path/to/repo

# Correlation repair
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts correlate --plain
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts correlate --repo /path/to/repo
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts correlate --repo /path/to/repo --execute

# Retention purge preview
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts purge --help
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts purge --lane all --older-than 14d
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts purge --lane low-signal --keep-latest 5

# Retention purge execute after inspecting preview
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts purge --lane all --older-than 14d --execute

# Capture and closeout
git check-ignore --quiet .skill-feedback/
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts record --help
bun run config/agents/skills/personal/skill-feedback/src/skill-feedback-runner.ts closeout < receipt.json
```
...
```bash
config/agents/skills/personal/test-runner/src/test-runner.sh run --cwd config/agents/skills/personal/skill-feedback -- src
```
