...
- v0 capture package: `config/agents/skills/personal/skill-feedback/docs/plans/2026-06-11-002-feat-skill-feedback-loop-v0-pilot-plan.md`.
- v1 report card and closeout: `config/agents/skills/personal/skill-feedback/docs/plans/2026-06-12-001-feat-skill-feedback-report-card-v1-plan.md`.
- v2 claim-safe review: `config/agents/skills/personal/skill-feedback/docs/plans/2026-06-13-001-feat-skill-feedback-claim-safe-review-result-v2-plan.md`.
- Review merge hardening: `config/agents/skills/personal/skill-feedback/docs/plans/2026-06-13-003-fix-skill-feedback-review-merge-readiness-plan.md`.
- Health command: `config/agents/skills/personal/skill-feedback/docs/plans/2026-06-15-001-feat-skill-feedback-health-command-plan.md`.
- Writer proof: `config/agents/skills/personal/skill-feedback/docs/plans/2026-06-24-001-fix-skill-feedback-capture-trust-run-correlation-plan.md`.
- Correlation witnesses: `config/agents/skills/personal/skill-feedback/docs/plans/2026-06-25-001-feat-skill-feedback-correlation-witnesses-plan.md`.
- Correlation backfill repair: `config/agents/skills/personal/skill-feedback/docs/plans/2026-06-28-001-fix-skill-feedback-correlation-backfill-plan.md`.
- P0/P1 ownership refactor: `config/agents/skills/personal/skill-feedback/docs/plans/2026-06-29-001-refactor-skill-feedback-p1-task-list-plan.md`.
