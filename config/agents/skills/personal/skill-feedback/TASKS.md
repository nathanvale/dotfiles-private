...
- Leave historical plan docs unchanged unless
      `config/agents/skills/personal/skill-feedback/docs/INDEX.md` or archive wording misleads current
  agents.
...
- 2026-06-30: Inherited Fallow cleanup closed. `audit` reports
  ...
  findings for `config/agents/skills/personal/skill-feedback`. Shared raw-object helpers removed the
