...
3. Record accepted decisions in the repository's declared decision owner when
   durable memory is useful.
...
- If the skill boundary is unresolved, use `grill-with-docs`.
