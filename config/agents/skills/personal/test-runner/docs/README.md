# Agent Runner Evidence Index

Current test-runner owners and shared runner-family constraints.

## Active foundations

- [skills/test-runner/SKILL.md](../SKILL.md)
- [claude/context/bun-runner.md](../../../../claude/context/bun-runner.md)
