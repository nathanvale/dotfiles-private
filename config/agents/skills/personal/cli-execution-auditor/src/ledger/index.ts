...
//
// Owns the complete auditor-local findings lifecycle and Markdown format:
// Open Findings / Finding History, finding states, signature dedupe, and
// never-delete history. The ledger intentionally models only auditor findings.
...
/** Auditor-local finding lifecycle states. */
...
/** Render the complete auditor-local ledger as Markdown. */
 ...
 * findings sections; ignores foreign sections so additional metadata does not
 * break the reader. Round-trips the findings this writer
