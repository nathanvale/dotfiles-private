...
The auditor owns its complete local findings lifecycle and Markdown format in
`src/ledger/`, including Open Findings / Finding History, `status:`, and
`signature`. This map names clause sources; it does not define ledger behavior.
