...
export const STATIONS: readonly Station[] = [
	...
	station("canva-auth.login", "DOMAIN_PRECONDITION_UNMET", "external", "a session already exists, or discovery, client registration, or the callback did not meet the contract", next(STATUS_ACTION), REPAIR.precondition),
