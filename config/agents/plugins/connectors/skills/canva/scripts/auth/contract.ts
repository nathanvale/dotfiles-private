...
export const STATIONS: readonly Station[] = [
	...
	station("canva-auth.login", "SUCCESS_COMPLETED", "external", "the browser callback returned a code and the token exchange stored a session", next(STATUS_ACTION), null),
