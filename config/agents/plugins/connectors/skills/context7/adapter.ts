// Context7's packaged adapter: the shared account-key shape (bin/account-key)
// bound to this Skill's fixed endpoint and Keychain leaf. Keyless until
// `connectors auth configure context7` records a 1Password item ID; then the key
...
export const context7Adapter = accountKeyAdapter({ id: "context7", label: "Context7", endpoint: ACCOUNT_ENDPOINT, readKeychain });
