// Private per-run diagnostics custody under ${XDG_STATE_HOME:-~/.local/state}/vault-steward/diagnostics/ (CLI-BRIEF.md
// section 3). Restored from the qualified complex reference packages/cli-design-exemplar/src/diagnostics-custody.ts
// with only the state directory renamed; the bounds (1 MB per run, 10 MB and 50 files aggregate, 7 days) are the
// accepted ones.
