// Fixture owner for the Vault Steward process tests: a fresh temp vault with the Unit 1 hook installed at
// .git/hooks/reference-transaction, Git helpers, and the hook installers. Every expected code, exit, warning, and
// stream in the tests is a literal; nothing is read from the production modules.
