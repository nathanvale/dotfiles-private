...
- Scope: conversational output to Nathan.
- Distinct from AGENTS.md telegraph/bullets rule for authored artifacts.
...
- Bad: three paragraphs plus a table for a one-line result.
- Good: result in one line; bullets only when they change what Nathan does next.
