...
if (import.meta.main) {
	...
	try {
		...
		const contextParts: string[] = [
			...
			'\nGit workflows: see docs/git/workflows.md for commit, squash, PR, changelog, compare, clean-gone procedures.',
		]

		// Plain stdout is reliably injected as context for PreCompact hooks.
