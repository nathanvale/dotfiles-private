...
- Exception: claude-code-config and dotfiles run main-direct mode (AGENTS.md "Context And Git" override) — edit their main checkouts on `main`; complex commits must pass `code-review` on the exact final diff, findings resolved, first.
